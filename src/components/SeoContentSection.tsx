...
export default function SeoContentSection() {
  return (
    <section className="w-full bg-[#f8f3e6] py-5">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="max-w-7xl mx-auto px-4 md:px-8 space-y-6 text-[#172A53]/85 text-sm md:text-base leading-relaxed text-justify"
      >
        <p>
