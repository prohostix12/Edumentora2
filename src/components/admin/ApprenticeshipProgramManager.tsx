    ...
    <div className="font-[Poppins] space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold text-[#172A53]">Saved Programs</h2>
          <button 
            onClick={() => {
              setEditingProgramId(null);
              setFormData(defaultFormData);
            ...
            className="bg-[#da251d] hover:bg-red-700 text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-colors"
          >
        ...
        {initialPrograms.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {initialPrograms.map(program => (
              <div key={program.id} className="bg-white border border-gray-200 rounded-2xl p-6 relative group hover:border-[#172A53]/30 transition-all shadow-sm hover:shadow-md cursor-pointer" onClick={() => handleEdit(program)}>
                <div className="absolute top-4 right-4 flex items-center gap-2 z-10" onClick={e => e.stopPropagation()}>
                  <button 
                    onClick={() => handleEdit(program)}
                    disabled={isPending}
                    className="text-gray-400 hover:text-[#172A53] bg-gray-50 p-2 rounded-lg transition-colors"
                  >
                ...
                <div className="mb-4">
                  <span className="px-3 py-1 bg-[#172A53]/10 text-[#172A53] text-xs font-bold uppercase rounded-full">
                    {program.topic}
                  </span>
                </div>
                <h3 className="text-xl font-bold text-[#172A53] mb-2 pr-20">{program.heading}</h3>
          ...
          <div className="bg-white w-full max-w-4xl rounded-3xl shadow-2xl" onClick={e => e.stopPropagation()}>
              ...
              <form id="apprenticeship-form" onSubmit={handleCreateProgram} className="space-y-12">
                ...
                <section className="space-y-6">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h3 className="text-lg font-bold text-[#da251d]">Hero Section</h3>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-2xl border border-gray-200">
                    <div className="space-y-4">
                      <div>
                        ...
                        <input required value={formData.topic} maxLength={50} onChange={e => setFormData({...formData, topic: e.target.value})} className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#172A53]/20 focus:border-[#172A53] outline-none text-[#172A53]" />
                      </div>
                      <div>
                        ...
                        <input required value={formData.heroHeading} maxLength={100} onChange={e => setFormData({...formData, heroHeading: e.target.value})} className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#172A53]/20 focus:border-[#172A53] outline-none text-[#172A53]" />
                      </div>
                      <div>
                        ...
                        <textarea required value={formData.heroParagraph} maxLength={300} onChange={e => setFormData({...formData, heroParagraph: e.target.value})} rows={3} className="w-full p-3 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-[#172A53]/20 focus:border-[#172A53] outline-none text-[#172A53]" />
                      </div>
                    </div>
                    <div>
                ...
                <section className="space-y-6">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h3 className="text-lg font-bold text-[#da251d]">Overview Section</h3>
                    <button type="button" onClick={() => addBlock('overviews')} className="text-[#da251d] font-bold text-sm flex items-center gap-1 hover:text-red-700 bg-red-50 px-3 py-1.5 rounded-lg"><Plus className="w-4 h-4"/> Add Overview</button>
                  </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <textarea required value={overview.paragraph} maxLength={600} onChange={e => {
                              ...
                              setFormData({...formData, overviews: newArr});
                            }} rows={4} className="w-full p-3 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-[#172A53]/20 focus:border-[#172A53] outline-none text-[#172A53]" />
                          </div>
                        </div>
                      </div>
                    ))}
                ...
                <section className="space-y-6">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h3 className="text-lg font-bold text-[#da251d]">How it Works</h3>
                    <button type="button" onClick={() => addBlock('howItWorksBlocks')} className="text-[#da251d] font-bold text-sm flex items-center gap-1 hover:text-red-700 bg-red-50 px-3 py-1.5 rounded-lg"><Plus className="w-4 h-4"/> Add Section</button>
                  </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          {block.steps.map((item, index) => (
                            <div key={index} className="bg-white p-4 rounded-xl border border-gray-200 space-y-3 shadow-sm">
                              <div className="w-8 h-8 bg-[#da251d] text-white font-bold rounded-lg flex items-center justify-center">{index + 1}</div>
                              <div>
                                ...
                                }} className="w-full p-2 border border-gray-200 rounded-lg text-sm outline-none text-[#172A53]" />
                              </div>
                              <div>
                                ...
                                <textarea required value={item.description} maxLength={300} onChange={e => {
                                  ...
                                  setFormData({...formData, howItWorksBlocks: newBlocks});
                                }} rows={3} className="w-full p-2 border border-gray-200 rounded-lg text-sm resize-none outline-none text-[#172A53]" />
                              </div>
                            </div>
                          ))}
                        </div>
                ...
                <section className="space-y-6">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h3 className="text-lg font-bold text-[#da251d]">Programs & Eligibility</h3>
                    <button type="button" onClick={() => addBlock('programsBlocks')} className="text-[#da251d] font-bold text-sm flex items-center gap-1 hover:text-red-700 bg-red-50 px-3 py-1.5 rounded-lg"><Plus className="w-4 h-4"/> Add Section</button>
                  </div>
                  <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <button type="button" onClick={() => addStringArrayItem('programsBlocks', blockIndex, 'ugPrograms')} className="text-[#da251d] text-xs font-bold flex items-center gap-1"><Plus className="w-3 h-3"/> Add</button>
                              </div>
                              <div className="space-y-2">
                                {block.ugPrograms.map((p, i) => (
                                  <div key={i} className="flex gap-2 items-center">
                                    <input value={p} maxLength={200} onChange={e => handleStringArrayChange('programsBlocks', blockIndex, 'ugPrograms', i, e.target.value)} className="flex-1 p-2 border border-gray-200 rounded-lg text-sm outline-none text-[#172A53] bg-white shadow-sm" />
                            ...
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <button type="button" onClick={() => addStringArrayItem('programsBlocks', blockIndex, 'pgPrograms')} className="text-[#da251d] text-xs font-bold flex items-center gap-1"><Plus className="w-3 h-3"/> Add</button>
                              </div>
                              <div className="space-y-2">
                                {block.pgPrograms.map((p, i) => (
                                  <div key={i} className="flex gap-2 items-center">
                                    <input value={p} maxLength={200} onChange={e => handleStringArrayChange('programsBlocks', blockIndex, 'pgPrograms', i, e.target.value)} className="flex-1 p-2 border border-gray-200 rounded-lg text-sm outline-none text-[#172A53] bg-white shadow-sm" />
                            ...
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <button type="button" onClick={() => addStringArrayItem('programsBlocks', blockIndex, 'whoCanApply')} className="text-[#da251d] text-xs font-bold flex items-center gap-1"><Plus className="w-3 h-3"/> Add</button>
                              </div>
                              <div className="space-y-2">
                                {block.whoCanApply.map((p, i) => (
                                  <div key={i} className="flex gap-2 items-center">
                                    <input value={p} maxLength={200} onChange={e => handleStringArrayChange('programsBlocks', blockIndex, 'whoCanApply', i, e.target.value)} className="flex-1 p-2 border border-gray-200 rounded-lg text-sm outline-none text-[#172A53] bg-white shadow-sm" />
                ...
                <section className="space-y-6">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h3 className="text-lg font-bold text-[#da251d]">Why Choose?</h3>
                    <button type="button" onClick={() => addBlock('whyChooseBlocks')} className="text-[#da251d] font-bold text-sm flex items-center gap-1 hover:text-red-700 bg-red-50 px-3 py-1.5 rounded-lg"><Plus className="w-4 h-4"/> Add Section</button>
                  </div>
                  <div className="space-y-8">
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
                          <div>
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <button type="button" onClick={() => addStringArrayItem('whyChooseBlocks', blockIndex, 'points')} className="text-[#da251d] text-xs font-bold flex items-center gap-1"><Plus className="w-3 h-3"/> Add Point</button>
                            </div>
                            <div className="space-y-2">
                              {block.points.map((p, i) => (
                                <div key={i} className="flex gap-2 items-center">
                                  <input value={p} maxLength={200} onChange={e => handleStringArrayChange('whyChooseBlocks', blockIndex, 'points', i, e.target.value)} className="flex-1 p-3 border border-gray-200 rounded-xl text-sm outline-none text-[#172A53] bg-gray-50" />
                          ...
                          <div>
                            ...
                            <textarea value={block.conclusion} maxLength={400} onChange={e => {
                              ...
                              setFormData({...formData, whyChooseBlocks: newArr});
                            }} rows={3} className="w-full p-3 border border-gray-200 rounded-xl resize-none outline-none text-[#172A53] bg-gray-50" />
                          </div>
                        </div>
                      </div>
                    ))}
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-3xl flex justify-end">
              <button 
                ...
                disabled={isPending}
                className="bg-[#da251d] hover:bg-[#172A53] text-white px-8 py-3 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50"
              >
