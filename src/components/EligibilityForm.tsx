      ...
      <form className={`w-full ${className}`} onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="relative">
            ...
            <label
              htmlFor="name"
              className="absolute left-3.5 top-1.5 text-[10px] font-semibold text-[#172A53] transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:font-normal peer-placeholder-shown:text-[#172A53] peer-placeholder-shown:top-2.5 peer-focus:top-1.5 peer-focus:text-[10px] peer-focus:font-semibold peer-focus:text-[#172A53] pointer-events-none"
            >
              Name
            </label>
          </div>
        ...
        <div className="fixed inset-0 z-[100] bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl border border-gray-100">
            <div className="flex flex-col gap-4">
              ...
              {popupState === 'success' && (
                <>
                  <h3 className="text-2xl font-bold text-[#172A53]">Request Submitted</h3>
              ...
              {popupState === 'error' && (
                <>
                  <h3 className="text-2xl font-bold text-[#172A53]">Submission Failed</h3>
