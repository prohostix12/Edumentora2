  ...
  return (
    <form className={className} onSubmit={handleSubmit}>
      ...
      <button 
        ...
        className={`w-full bg-[#172A53] hover:bg-[#111f3d] text-white font-bold py-4 rounded-xl transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 duration-200 disabled:opacity-70 disabled:cursor-not-allowed ${isGrid ? 'md:col-span-2' : ''}`}
      >
