...
export default function ProcessSection() {
  const features = [
    {
      icon: <ArrowRightLeft className="w-8 h-8 text-[#172A53]" />,
    ...
    <section className="relative w-full py-16 overflow-hidden bg-gray-50">
      <div className="max-w-[1400px] mx-auto px-4 lg:px-[80px] relative z-10 flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
        ...
        <div className="w-full lg:w-1/2 pr-0 lg:pr-8 pt-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#172A53] leading-tight mb-4">
          ...
          <div className="flex flex-col gap-6">
            {features.map((feature, index) => (
               ...
               >
                 ...
                 <div>
                   <h3 className="text-xl font-bold text-[#172A53] mb-2">
                     {feature.title}
                   </h3>
        ...
        <div className="w-full lg:w-1/2 pt-12 lg:pt-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#172A53] leading-tight">
                ...
                >
                  ...
                  <div className={`w-full md:w-[45%] flex ${index % 2 === 0 ? 'justify-end' : 'justify-start'}`}>
                    <div className="bg-white rounded-2xl p-6 shadow-xl hover:-translate-y-1 transition-transform duration-300 w-full group cursor-pointer relative overflow-hidden border border-gray-50">
                      ...
                      <h4 className="text-lg font-bold text-[#172A53] mb-1 pr-6">{process.title}</h4>
                      <p className="text-gray-500 text-sm">{process.desc}</p>
                    </div>
                  </div>

                  {/* Center Dot */}
                  <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-white shadow-md border-4 border-gray-50 items-center justify-center z-10 text-[#172A53] font-bold">
                    {process.num}
                  </div>
