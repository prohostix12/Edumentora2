  ...
  return (
    <section ref={sectionRef} className="w-full bg-white overflow-hidden mb-[10px] -mt-[60px] relative z-10 dot-grid">
      ...
      >
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-[#002147] my-5">
            About Edumentora
          </h2>

          <div className="border-l-4 border-[#D2B48C] pl-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-[#D2B48C]/10 rounded-xl flex items-center justify-center shadow-sm">
              <Phone className="w-6 h-6 text-[#D2B48C]" />
            </div>
            <div>
              <p className="text-gray-500 text-sm font-medium">Call Us Anytime</p>
              <p className="text-[#002147] font-bold text-lg">+91 974458 7777</p>
            </div>
          </div>

          <div>
            <button className="bg-[#8B0000] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#8B0000]/90 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 duration-300">
              About Us
            </button>
          </div>
        </motion.div>
