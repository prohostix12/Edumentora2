        ...
        {(university.visionHeading || university.visionPara) && (
          <div>
            {university.visionHeading && (
              <h3 className="text-2xl font-bold text-[#002147] mb-4">{university.visionHeading}</h3>
            )}
        ...
        {(university.facilitiesHeading || university.facilitiesPara) && (
          <div>
            {university.facilitiesHeading && (
              <h3 className="text-2xl font-bold text-[#002147] mb-4">{university.facilitiesHeading}</h3>
            )}
        ...
        {(university.featuresHeading || university.featuresPara) && (
          <div>
            {university.featuresHeading && (
              <h3 className="text-2xl font-bold text-[#002147] mb-4">{university.featuresHeading}</h3>
            )}
        ...
        {(university.whyChooseHeading || university.whyChoosePara) && (
          <div>
            {university.whyChooseHeading && (
              <h3 className="text-2xl font-bold text-[#002147] mb-4">{university.whyChooseHeading}</h3>
            )}
        ...
        {(university.btechProgramsHeading || university.btechProgramsPara) && (
          <div>
            {university.btechProgramsHeading && (
              <h3 className="text-2xl font-bold text-[#002147] mb-4">{university.btechProgramsHeading}</h3>
            )}
