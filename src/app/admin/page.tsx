...
export default function AdminDashboard() {
  return (
    <div className="p-8 font-[Poppins]">
      <h1 className="text-3xl font-bold text-[#172A53] mb-8">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-center h-32">
          ...
          <h2 className="text-4xl font-bold text-[#172A53]">0</h2>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-center h-32">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h2 className="text-xl font-bold text-[#172A53] mb-4">Welcome to Edumentora Admin</h2>
